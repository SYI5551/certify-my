  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6 footer-contact">
        <h3>Certify.My</h3>
        <p>
            Bintara Solutions Sdn. Bhd. <br>
            27-3, Jalan Setiawangsa 9,<br>
            Taman Setiawangsa, <br>
            54200 Kuala Lumpur,<br>
            Wilayah Persekutuan Kuala Lumpur.<br><br>
            <strong>Phone:</strong> 03-4266 3311<br>
            <strong>Fax:</strong> 03-4251 1000<br>
            <strong>Email:</strong> info@bintara.com.my<br>
        </p>
      </div>
...
<div class="container footer-bottom clearfix">
  <div class="copyright">
    &copy; Copyright <strong><span>Bintara Solutions SDN BHD</span></strong>. All Rights Reserved
  </div>
  <div class="credits">
